						...
						<div class="header-main">
							...
							<div class="header-right">
								<div class="header-page-link">
									<?php if( isset($davici_settings['shipping']) && $davici_settings['shipping'] ) : ?>
									<div class="phone ship hidden-xs hidden-sm hidden-md ">
										<i class="icon-delivery-truck"></i>
										<div class="content">
											<label class="font-bold"><?php echo esc_html__("FREE SHIPPING  ","davici") ?></label>
											<span><?php echo esc_html($davici_settings['shipping']); ?></span>
										</div>
									</div>
									<?php endif; ?>
				...
				<div class="header-bottom">
					<div class="container">
						<div class="content-header-bottom">
							...
							<div class="list-link-menu hidden-sm hidden-xs">
