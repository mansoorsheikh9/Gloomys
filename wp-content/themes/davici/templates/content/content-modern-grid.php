<?php 
	...
	$class = 'grid-post '.esc_attr(davici_get_class()->class_item_blog);
?>
<div class="box-entry-post">
			...
			<div class="post-content">
				...
				<?php
					if (davici_get_config('blog-excerpt')) {
						echo davici_get_excerpt( davici_get_config('grid-blog-excerpt-length',20), true);
					}
				?>
			</div>
		</div>
