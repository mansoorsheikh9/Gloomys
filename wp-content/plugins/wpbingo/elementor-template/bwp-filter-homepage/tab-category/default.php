...
if( $category ){	
	...
	$cat_selected = '';	
?>
<div class="bwp-filter-homepage tab-category tab-category-default <?php echo esc_attr($class); ?>" data-class_col = "<?php echo esc_attr($class_col); ?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>">
