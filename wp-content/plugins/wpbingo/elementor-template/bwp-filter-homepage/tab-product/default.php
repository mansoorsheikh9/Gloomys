...
?>
<div class="bwp-filter-homepage tab-product <?php echo esc_attr($layout); ?> <?php echo esc_attr($class); ?>" data-class_col = "<?php echo esc_attr($class_col); ?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>">
