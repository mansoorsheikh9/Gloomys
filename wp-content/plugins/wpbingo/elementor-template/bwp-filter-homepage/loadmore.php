...
?>
<div class="bwp-filter-homepage loadmore <?php echo esc_attr($class); ?>" data-content_product="5" data-class_col = "<?php echo esc_attr($class_col); ?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>">
